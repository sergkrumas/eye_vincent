...
Во время большого перерыва все доступные экраны будут выводить нечто такое (фон будет не полностью сплошной чёрный, в нём подмешан процент прозрачности, и таким образом, будет видно, что находится под окном):
