...
- ***Большой перерыв*** полностью блокирует все экраны. Правда, при необходимости блокировку можно отменить не дожидаясь её конца через контекстное меню в верхней части любого блокирующего окна.
    ...
    - Во время большого перерыва все доступные экраны будут выводить нечто такое:

        ![](https://github.com/user-attachments/assets/3a3b5c32-0178-4a9c-af55-ea5b1cc235c0)
    - Фоном будет не полностью сплошная чёрная заливка - в фон подмешан процент прозрачности, и таким образом, будет видно, что находится под окном
...
23.02.2026
  - изменена иконка, она будет окрашиваться в полностью белый/чёрный цвет в зависимости от выбранной темы Windows (тёмная тема или светлая тема)
